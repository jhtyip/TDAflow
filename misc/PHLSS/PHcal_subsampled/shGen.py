...
for line in Lines:
    ...
    for k in k_array:
        ...
        for subfolders_item in subfolders:
            ...
            f.write(r"request_memory = 5GB"+"\n")  # 4
            f.write(r"request_disk = 4GB"+"\n\n")  # 3

            f.write(r"queue subfolder_item_noSlash,firstNum,secondNum,pythonArgv from ./fileLists/fileList_"+subfolders_item.replace("/", "")+"_"+this[3]+r".txt"+"\n")
    ...
    for k in k_array:
        ...
        for subfolders_item in subfolders:
            if subfolders_item != this[0]:
                continue
            if r"condor_submit "+"sub_PHcal_"+subfolders_item.replace("/", "")+"_"+str(k)+".sub"+"\n" not in inG:
                g.write(r"condor_submit "+"sub_PHcal_"+subfolders_item.replace("/", "")+"_"+str(k)+".sub"+"\n")
                inG.append(r"condor_submit "+"sub_PHcal_"+subfolders_item.replace("/", "")+"_"+str(k)+".sub"+"\n")
g.close()